...
- Rename all the API definitions/ Forms/ Pages etc. by expanding all elements in the tree view, select all, right-click for rename and do Find (PurchaseOrder) and Replace (Your Entity Name) 
- Map each API definition to the relevant operation of your API designer API
- Delete any API that you are not going to use
- Search and Replace all Code for "PurchaseOrder" and replace with your Entity Name
